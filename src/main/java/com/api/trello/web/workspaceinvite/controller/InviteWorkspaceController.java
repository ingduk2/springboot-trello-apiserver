...
public class InviteWorkspaceController {
    ...
    public ResponseEntity<SuccessResponse> inviteWorkspace(@RequestBody @Valid
        ...
        Long invite = inviteWorkspaceService.invite(requestDto.getWorkspaceId(), requestDto.getInvitedMemberId());
        return ResponseEntity.ok(SuccessResponse.success(invite));
    }
}
